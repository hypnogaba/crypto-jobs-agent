 ...
 *
 * «Побажання» стояли ОДРАЗУ після сфер, і підстава була така: людина щойно
 * побачила кнопки й знає, чого в них немає. Ця підстава зникла разом із
 * кнопками. Тепер вона щойно написала про себе власними словами, і питання
 * «що ще важливо?» наступним екраном перепитує те саме — а два вільні
 * питання поспіль читаються як «ти відповів неправильно, спробуй ще».
 *
 * Заразом полагоджено лічильник: «1 з 3», «2 з 3», «3 з 3» тепер ідуть
