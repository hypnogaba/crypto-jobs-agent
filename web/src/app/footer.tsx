    ...
    <footer className="mt-auto border-t" style={{ borderColor: "var(--rule)" }}>
      <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-5 px-6 py-8 text-sm"
        ...
        <nav className="flex flex-wrap gap-5">
          {/* Розділ добірок англійською й лише англійською — тому й посилання
              без pathFor. Воно тут заради обходу: сторінка, на яку не веде
              жодне посилання з сайту, індексується погано, скільки б її не
              було в карті сайту. */}
          <Link href="/jobs" className="hover:opacity-70">{t(locale, "nav.jobs")}</Link>
