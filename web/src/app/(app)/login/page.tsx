...
// Сторінка живе в (app), а не серед публічних: тут одна кнопка в Telegram і
// майже нуль тексту. Тонка сторінка в індексі не ранжується, а лише розмиває
// обхід — тому ні canonical, ні hreflang їй не потрібні, а noindex стоїть у
// layout групи.
