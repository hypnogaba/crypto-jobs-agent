...
import { ashbyPay, currencyCode, getroPay, greenhousePay, leverPay, payPeriod, yearly } from "./pay.js";
...
describe("getroPay", () => {
  it("центи й рік", () => {
    expect(getroPay({ compensation_amount_min_cents: 2_500_000, compensation_amount_max_cents: 3_500_000,
