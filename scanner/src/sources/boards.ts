...
export interface Board {
  ...
  salaryPeriod?: string;
  /**
   * Ніша дошки, що успадковується кожною її вакансією.
   *
   * Дошка вміла сказати «це Україна» і не вміла сказати «це крипта», хоча
   * jobstash.xyz і web3.career інших вакансій не тримають взагалі. Тег
   * `web3` ставився лише тим рядкам, у назві яких випадково траплялось
   * слово «crypto», тобто 2% з 1651. Опис читати не вихід: він є лише в
   * 21% кеша.
   *
   * Порожньо — дошка не нішева, і це нормальний, найчастіший випадок.
   */
  tags?: string[];
}
